...
import Map from "../images/2020-clean-water-act-map"
...
<Link to="/data/reports"><img src={Map} alt='Map of Congressional Report Cards' height="685" width="970"/></Link>

<Link to='/data/reports' className='button' rel='noreferrer noopener'>Show me the reports</Link>
