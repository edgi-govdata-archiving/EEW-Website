...
<Layout pageTitle="2020 EPA Oversight Reports" sidebarLinks={DataPageSidebarLinks} activeHeaderLink="Data">

# 2020 Congressional Committee Report Cards
...
<img src={Map} alt='Map of Congressional Report Cards' height="685" width="970"/>

To view our summary report of all districts and states analyzed, see:

<strong>Summary Report:</strong> <a href="https://envirodatagov.org/wp-content/uploads/2020/10/Democratizing-Data-Summary-Report.pdf" target='_blank' rel='noopener' >Democratizing Data: Environmental Enforcement Watch's Report Cards for Congressional Oversight of the EPA</a>
...
<ReportCardExplorer reportData={SenateEnvironmentAndPublicWorksCommitteeData} reportTitle='Senate Environment and Public Works Committee' />
<ReportCardExplorer reportData={HouseEnergyAndCommerceCommittee} reportTitle='House Energy and Commerce Committee' />
